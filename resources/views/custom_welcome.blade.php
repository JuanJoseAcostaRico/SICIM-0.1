                ...
                <div class="header-right-btn f-right d-none d-lg-block ml-30">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 btn header-btn">Registrar</a>
                        @endif
                    @endauth
                </div>
            @endif
                ...
                <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                  <div class="hero__caption">
                    ...
                    <p
                      ...
                      align="justify"
                    >
                      En el CDI de Coloncito nos preocupamos por tí. <br/> Porque mejorar la vida, es nuestra misión
                    </p>
                    <a
                      href="#acerca"
                      class="btn hero-btn"
              ...
              <div class="about-caption mb-50">
                ...
                <div class="about-btn1 mb-30">
                  <a href="#especialistas" class="btn about-btn"
                    >Nuestros Especialistas<i class="fas fa-chevron-right"></i
                  ></a>
                </div>
              </div>
            </div>
                ...
                <div class="single-testimonial text-center">
                    ...
                    <div class="testimonial-caption ">
                        <div class="testimonial-top-cap">
                            ...
                            <p>“Nuestro objetivo es garantizar la atención integral a la salud a través del diagnóstico, tratamiento y rehabilitación oportuna, eficaz y eficiente de las patologías de mayor repercusión en la población.”</p>
                        </div>
                        <!-- founder -->
                ...
                <div class="footer-copy-right">
                  <p>
                    ...
                    Todos los derechos reservados |
                     por
                    <a href="#" target="_blank">los creadores del sitio web</a>
